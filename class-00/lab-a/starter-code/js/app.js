...
function displayPics() {
  ...
  //  The consolelog(rando) does not work because when we change var to const rando=makerandom() it puts it in a block fonction and things insde of a block can not be accessed outside of the block.
